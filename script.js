...
client.on("ready", () => {
    ...
    client.user.setActivity({name: "Abhay!", type: "STREAMING", url: "https://abhay-web-folio.netlify.app/"})
    Main();
});
...
/**
 * Scrape Users
 * @param {string} guildID ID of the guild which to scrape the users from
 */
